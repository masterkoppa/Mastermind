...
public class GameLog {
	 ...
	 * 
	 * @param fileName
	 *            the file name to configure
	 * @throws FileExistsException
	 *             Throws if the file specified already exists
	 * @throws IOException
	 */
	public static synchronized void configureForFileName(String fileName,
			Boolean overwriteFile) throws FileExistsException, IOException {
		...
		if (f.exists() && !overwriteFile) {
			throw new FileExistsException(
					"Game Log for that file name already exists");
		} else {
