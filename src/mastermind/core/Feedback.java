...
public class Feedback {
	...
	/**
	 * Analyzes the secret code versus the guess and returns a immutable feedback 
	 * object containing the feedback from the system to be shown to the user.
	 * @param secretCode - Validated code containing the secret code made by the code maker
	 * @param guess - Validated code containing the guess made by the code breaker
