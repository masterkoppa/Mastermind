 ...
 * 
 * ComputerCodebreaker uses the Strategy pattern to delegate the guessing algorithm.
 * 
...
public class ComputerCodebreaker {
	 ...
	 * @param guessBehavior		the guessing algorithm used by this codebreaker
	 */
	 ...
	 * 
	 * @param guessBehavior		the guessing algorithm to switch to
	 */
